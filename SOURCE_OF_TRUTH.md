...
NEWSROOM_HARNESS_SCHEDULER_ENABLED=false
NEWSROOM_HARNESS_SCHEDULER_INTERVAL_MS=30000

# AI
OPENAI_API_KEY=
NEWSROOM_MODEL_POLICY_MODE=cost_saver
NEWSROOM_ALLOW_SCHEDULED_MODEL_CALLS=false
NEWSROOM_ALLOW_SCHEDULED_WEB_SEARCH=false
NEWSROOM_MODEL_NANO=gpt-5.4-nano
NEWSROOM_MODEL_MINI=gpt-5.4-mini
NEWSROOM_MODEL_STANDARD=gpt-5.4
NEWSROOM_MODEL_PREMIUM=gpt-5.4
